...
var SevenMachine = /** @class */ (function () {
    ...
    SevenMachine.prototype.serialize = function () {
        ...
        for (var k in this.reactiveVariableMap) {
            if (Object.prototype.hasOwnProperty.call(this.reactiveVariableMap, k)) {
                var reactiveVariable = this.reactiveVariableMap[k];
    ...
    SevenMachine.deserialize = function (st) {
        ...
        var reactiveVarMap = {};
        for (var k in st.reactiveVariableMap) {
            if (Object.prototype.hasOwnProperty.call(st.reactiveVariableMap, k)) {
                var element = st.reactiveVariableMap[k];
